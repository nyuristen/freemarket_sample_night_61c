Rails.application.routes.draw do
  ...
  get '/mypage/listed_all', to: 'mypage#listed_all'
  get '/mypage/listed_listing', to: 'mypage#listed_listing'
  get '/mypage/listed_negotiating', to: 'mypage#listed_negotiating'
  get '/mypage/listed_soldout', to: 'mypage#listed_soldout'
  get 'logout/index'
